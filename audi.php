...
?>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="img/motoes.png" type="image/png">
    ...
    <body class="animsition">
        ...
        <div class="site-hero_2">
            <div class="page-title">
                <div class="big-title montserrat-text uppercase">Audi</div>
        ...
        <section>
            <div class="container">
                <div class="section-title">
                    <span>История</span>
                    <p>Нарастание и начало <b>Второй мировой войны</b> способствовали разработке и производству специальных транспортных средств для военных целей <b>в 1930-х годах</b>. <b>Auto Union</b> стал важным поставщиком транспортных средств для вооруженных сил <b>Германии</b>. После начала войны гражданское производство было прервано </b>в мае 1940 года</b>. После этого компания производила исключительно для военных целей.</p>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <img src="img/audi_a7_vossen_tyuning_diski_97430_1920x1080.jpg" class="wow fadeInUp" style="margin-bottom:30px" />
                        <img src="img/thumb2-audi-q8-4k-garage-2019-cars-abt.jpg" class="wow fadeInUp" style="margin-bottom:30px" />
                        <img src="img/audi_r8_v10_sinij_vid_sboku_109948_1920x1080.jpg" class="wow fadeInUp" style="margin-bottom:30px" />
                    </div>
                    <div class="col-md-4">
            ...
            <div class="light-gray-section wow fadeInUp" style="padding:15px 30px">
                <div class="row">
                    <p class="italic" style="float:left;line-height:50px;margin:0">
                        ...
                        $ros = $pdo->query("SELECT * FROM `model`,`privod`,`marka`,`kuzov`,`color` WHERE model.privod_id = privod.id_privod and model.marka_id = marka.id_marka and model.kuzov_id = kuzov.id_kuzov and model.color_id = color.id_color and marka.id_marka= 3  ORDER BY marka.marka_name");
                        foreach ($ros as $rows) {
